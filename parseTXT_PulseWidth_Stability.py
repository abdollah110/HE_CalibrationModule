...
#            scanvas.SaveAs("singleEv_"+str(iAmp)+"_"+str(event)+str(RootName)+".pdf")
...
#            y[event]= sigSum- Pedestal*5
        ...
        highVal = histMean + 3 * histRMS
        lowVal = histMean - 3 * histRMS
...
#        FitParErr=mfit.GetParError()
        ...
        fitInfo.Draw()
        canvas.SaveAs("width_HistoSingleRun_"+str(iAmp)+"_"+Title+RootName+".pdf")
...
#    Graph_IntegralErDown.Draw("same")
    ...
    Graph_Integral_RMS.GetYaxis().SetRangeUser(0,0.03)
    Graph_Integral_RMS.Draw()
#    Graph_Integral_RMSErUp.Draw("same")
#    Graph_Integral_RMSErDown.Draw("same")
    canvas_Integral_RMS.SaveAs("width_Integral_RMS_"+Title+RootName+".pdf")
    ...
    Graph_Ratio.GetYaxis().SetRangeUser(0.0,0.02)
    Graph_Ratio.GetXaxis().SetTitle("Day")
    Graph_Ratio.Draw()
    canvas_Ratio.SaveAs("width_Ratio_"+Title+RootName+".pdf")
